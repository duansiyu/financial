    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.record} onPress={this._gotoWithdrawRecord}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.content}>
                        ...
                        <Text style={styles.font_orange}>成功提现</Text>
                    ...
                    <View style={styles.btns}>
                        ...
                        <TouchableOpacity style={styles.button} onPress={this._gotoWithdrawRecord}>
