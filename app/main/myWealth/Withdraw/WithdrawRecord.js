...
const contents=[
    {'money':'100.00', 'shouXuFei': '2.00', 'time': '7-30 13:36:25'},
    {'money':'300.00', 'shouXuFei': '3.00', 'time': '7-28 08:36:12'},
    {'money':'5406.00', 'shouXuFei': '25.12', 'time': '7-18 15:36:35'},
    {'money':'954.00', 'shouXuFei': '14.00', 'time': '7-02 06:36:24'}
]
        ...
        return(
            <View style={styles.list}>
                <View>
                    ...
                    <Text style={styles.txt}>￥{rowData.withdrawAmount}</Text>
                </View>
                <View>
                    <Text style={styles.title}>手续费</Text>
                    <Text style={styles.txt}>￥{rowData.deposit}</Text>
                </View>
                <View>
                    <Text style={styles.title}>提现时间</Text>
                    <Text style={styles.txt}>{rowData.applytime}</Text>
                </View>
            </View>
        )
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                <TitileBar title='提现记录'  leftBtnFunc={this._goBack.bind(this)}/>
                {/*
                <View style={styles.top}>
                    <Text style={styles.year}>2016</Text>
                    <Text style={styles.tips}>只显示最近的50条提现数据</Text>
                </View>
                */}
